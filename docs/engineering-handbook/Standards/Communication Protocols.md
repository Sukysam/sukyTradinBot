...
human-only teams and Claude sessions acting under this handbook. The goal is
...
2. **Which invariant/rule** — cite the handbook section (e.g. "Master Charter
...
- Links to the handbook sections that frame the decision (the receiving role's
...
chat/PR comments and never written into the handbook is, for this project's
