...
without reading the code" as small as possible — including this Kit. Own
...
- This Kit (`Claude AI Development Kit/`) in its entirety.
...
- Every cross-reference link in this Kit is a relative markdown link that
  actually resolves — verify link targets exist when adding or moving
  files.
- No document in this Kit states a numeric threshold, spec section, or
...
- This Kit was generated by reading the code as of 2026-07-12, not by
...
- The Capability Ownership Map is the single highest-value piece of
  documentation in this Kit for a system with as many "production-grade"
