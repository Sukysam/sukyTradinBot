...
| Execution Layer | `execution` | 0.1.0 | `OrderIntent` | v1 | (planned) broker adapter consumers, adaptive learning, backtesting | [ADR-012](engineering-handbook/Architecture/ADR/ADR-012-OrderIntent-Contract.md) (contract freeze), [ADR-013](engineering-handbook/Architecture/ADR/ADR-013-Execution-Layer-Design.md) (design); binding spec: [Standards/OrderIntent Contract.md](engineering-handbook/Standards/OrderIntent%20Contract.md) |
| Backtesting & Validation | `backtest` (not yet built; distinct from the pre-existing, untooled `backtest/` sandbox) | — | `BacktestResult` | v1 (contract frozen; no implementation yet) | (planned) adaptive learning, documentation/model cards | [ADR-014](engineering-handbook/Architecture/ADR/ADR-014-BacktestResult-Contract.md); binding spec: [Standards/BacktestResult Contract.md](engineering-handbook/Standards/BacktestResult%20Contract.md) |
