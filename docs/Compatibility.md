...
| Execution Layer | `execution` (not yet built) | — | `OrderIntent` | v1 (contract frozen; no implementation yet) | (planned) broker adapter(s) | [ADR-012](engineering-handbook/Architecture/ADR/ADR-012-OrderIntent-Contract.md); binding spec: [Standards/OrderIntent Contract.md](engineering-handbook/Standards/OrderIntent%20Contract.md) |
